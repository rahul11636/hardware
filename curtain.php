<?php include('header.php'); ?>
      ...
      <!-- breadcrumb-area -->
			...
			<!-- shop-area -->
            <section class="shop-area pt-50 pb-50 p-relative " data-animation="fadeInUp animated" data-delay=".2s">
                <div class="container">
					<div class="row">
                 ...
                 <div class="col-lg-4 col-md-6">
                    <div class="product mb-40">
                          ...
                          <a href="shop-details.html"><img src="img/wash_towel/wash1.png" alt=""></a>
      ...
      <div class="product__content text-center pt-30">
              ...
              <div class="product mb-40">
              <div class="product__img">
                        <a href="shop-details.html"><img src="img/curtain/curtain2.png"  alt=""></a>
                               <div class="product-action text-center">
             ...
             <div class="product__content text-center pt-30">
                ...
                <div class="col-lg-4 col-md-6">
                        <div class="product mb-40">
                        <div class="product__img">
                        <a href="shop-details.html"><img src="img/curtain/curtain3.png" alt=""></a>
                       <div class="product-action text-center">
                     ...
                     <div class="product__content text-center pt-30">
                         ...
                         <h4 class="pro-title"><a href="shop-details.html">Sikkar Product</a></h4>
                                    ...
                                    <div class="col-lg-4 col-md-6">
                                        <div class="product mb-40">
                                            <div class="product__img">
                                                <a href="shop-details.html"><img src="img/curtain/curtain4.jpg" alt=""></a>
                                                <div class="product-action text-center">
                                    ...
                                    <div class="col-lg-4 col-md-6">
                                        <div class="product mb-40">
                                            <div class="product__img">
                                                <a href="shop-details.html"><img src="img/curtain/curtain5.jpg" alt=""></a>
                                                <div class="product-action text-center">
                                    ...
                                    <div class="col-lg-4 col-md-6">
                                        <div class="product mb-40">
                                            <div class="product__img">
                                                <a href="shop-details.html"><img src="img/curtain/curtain6.jpg" alt=""></a>
                                                <div class="product-action text-center">
									...
									<div class="col-lg-4 col-md-6">
                                        <div class="product mb-40">
                                            <div class="product__img">
                                                <a href="shop-details.html"><img src="img/curtain/curtain7.jpg" alt=""></a>
                                                <div class="product-action text-center">
                                    ...
                                    <div class="col-lg-4 col-md-6">
                                        <div class="product mb-40">
                                            <div class="product__img">
                                                <a href="shop-details.html"><img src="img/curtain/curtain8.jpg" alt=""></a>
                                                <div class="product-action text-center">
                                    ...
                                    <div class="col-lg-4 col-md-6">
                                        <div class="product mb-40">
                                            <div class="product__img">
                                                <a href="shop-details.html"><img src="img/curtain/curtain9.jpg" alt=""></a>
                                                <div class="product-action text-center">
